...
export class TextStyles {
    ...
    setConstants(width) {
        ...
        TextStyles.SIZE_LARGE2 = width / 14;
        ...
        TextStyles.MAIN_FONT = "proxima-nova, sans-serif";
    ...
    setDefaults() {
        ...
        this.styles['QUESTION_WHITE'] = {
            style: {
                fontFamily: TextStyles.MAIN_FONT,
                fontSize: TextStyles.SIZE_LARGE2,
                color: "#ffffff",
                wordWrap: { width: this.width / 1.5 }
            }
        };
