...
export class SceneLoad extends BaseScene {
    ...
    preload() {
        ...
        //game png
        //
        let pngArray = ['panelBack','title','face','background','FRJ_logo_2020','judoguy','judoguy2'];
        ...
        this.load.json('quiz', 'assets/quiz.json');
        //used for point box
